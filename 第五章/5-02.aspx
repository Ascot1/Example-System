<%@ Page Language="C#" AutoEventWireup="true" CodeFile="5-02.aspx.cs" Inherits="_5_02" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>5-02 运用CompareValidator控件</title>
</head>
<body>
    ...
    <div>
      ...
      <asp:CompareValidator ID ="cvPassword" runat="server" ControlToCompare="txtPassword" ControlToValidate="txtPasswordAgain">密码与确认密码不一致</asp:CompareValidator>
      答案：<asp:TextBox ID ="txtAnswer" runat ="server"></asp:TextBox>
      <asp:CompareValidator ID ="cvAgain" runat ="server" ControlToValidate="txtAnswer" ValueToCompare="A">答案错误！</asp:CompareValidator><br />
