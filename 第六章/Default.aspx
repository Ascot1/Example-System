...
<form id="form2" runat="server">
    ...
    border="1px" cellpadding="0.5px" cellspacing="0.5px">
        <tr>
            <td class="style7" 
                >
                <a href="6-01.aspx">实例6-01</a></td>
            <td class="style7"  >
                <a href="6-02.aspx">实例6-02</a></td>
            <td class="style7" >
                <a href="6-03.aspx">实例6-03</a></td>
        </tr>
        <tr>
            <td class="style7">
                <a href="6-04.aspx">实例6-04</a></td>
            <td class="style7"  >
                <a href="6-05.aspx">实例6-05</a></td>
            <td class="style7" ">
                <a href="6-06.aspx">实例6-06</a></td>
        </tr>
        <tr>
            <td class="style7"  >
                <a href="6-07.aspx">实例6-07</a></td>
            <td class="style7" >
                 <a href="6-08.aspx">实例6-08</a></td>
            <td class="style7" >
                <a href="6-09.aspx">实例6-09</a></td>
        </tr>
