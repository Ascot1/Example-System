...
<form id="form2" runat="server">
    ...
    border="1px" cellpadding="0.5px" cellspacing="0.5px">
        <tr>
            <td class="style7" 
                >
                <a href="3-01.aspx">实例3-01</a></td>
            <td class="style7"  >
                <a href="3-02.aspx">实例3-02</a></td>
            <td class="style7" >
                <a href="3-03.aspx">实例3-03</a></td>
        </tr>
        <tr>
            <td class="style7">
                <a href="3-04.aspx">实例3-04</a></td>
            <td class="style7"  >
                <a href="3-05.aspx">实例3-05</a></td>
            <td class="style7" ">
                <a href="3-06.aspx">实例3-06</a></td>
        </tr>
        <tr>
            <td class="style7"  >
                <a href="3-07.aspx">实例3-07</a></td>
            <td class="style7" >
                 <a href="3-08.aspx">实例3-08</a></td>
            <td class="style7" >
                <a href="3-09.aspx">实例3-09</a></td>
        </tr>
