...
<form id="form2" runat="server">
    ...
    border="1px" cellpadding="0.5px" cellspacing="0.5px">
        <tr>
            <td class="style7" 
                >
                <a href="8-01.aspx">实例8-01</a></td>
            <td class="style7"  >
                <a href="8-02.aspx">实例8-02</a></td>
            <td class="style7" >
                <a href="8-03.aspx">实例8-03</a></td>
        </tr>
        <tr>
            <td class="style7">
                <a href="8-04.aspx">实例8-04</a></td>
            <td class="style7"  >
                <a href="8-05.aspx">实例8-05</a></td>
            <td class="style7" ">
                <a href="8-06.aspx">实例8-06</a></td>
        </tr>
        <tr>
            <td class="style7"  >
                <a href="#"></a></td>
